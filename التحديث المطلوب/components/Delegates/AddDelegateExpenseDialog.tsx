...
interface AddDelegateExpenseDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: AddExpenseFormValues) => void;
}

export function AddDelegateExpenseDialog({ isOpen, onClose, onSubmit }: AddDelegateExpenseDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>تسجيل مصروف جديد للمندوب</DialogTitle>
        </DialogHeader>
        <Form {...form}>
